    ...
    def make_data(self, out_name):
        ...
        for i in range(len(file_names)): 
            ...
            if file_names[i][-5] == 'A' and file_names[i+1][-5] == 'B':
                ...
                img3 = os.path.join(self.path, file_names[np.random.randint(0, len(file_names))])
                ...
                img3 = cv2.imread(img3, cv2.IMREAD_UNCHANGED)
                ...
                img3 = cv2.resize(img3, (self.img_size, self.img_size), interpolation= cv2.INTER_AREA)
